...
public class SensorCopy implements Runnable
{
  //Attributes
  ...
  public SensorCopy(String loc){
    ...
    {
      this.co2MaxValue = 100000;
      this.so2MaxValue = 25;
      this.no2MinValue = 0.002;
      this.no2MaxValue = 0.1;
    }
    else if (loc.equalsIgnoreCase("toronto"))
    {
      this.co2MaxValue = 5000;
      this.so2MaxValue = 100;
      this.no2MinValue = 0.008;
      this.no2MaxValue = 6;
    }
    else{ //brampton
      this.co2MaxValue = 3000;
      this.so2MaxValue = 50;
      this.no2MinValue = 0;
      this.no2MaxValue = 0.1;
    }
